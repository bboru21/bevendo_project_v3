...
class ABCProduct(models.Model):
    ...
    best_price_700_ml = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=None, blank=True)
    ...
    avg_price_700_ml = models.DecimalField(max_digits=10, decimal_places=2, null=True, default=None, blank=True)
